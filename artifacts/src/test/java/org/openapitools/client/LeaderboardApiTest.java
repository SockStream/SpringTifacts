...
public class LeaderboardApiTest {
    ...
    public void getAccountsLeaderboardLeaderboardAccountsGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        DataPageAccountLeaderboardSchema response = api.getAccountsLeaderboardLeaderboardAccountsGet(sort, name, page, size);
    ...
    public void getCharactersLeaderboardLeaderboardCharactersGetTest() throws ApiException {
        ...
        Integer page = null;
        Integer size = null;
        DataPageCharacterLeaderboardSchema response = api.getCharactersLeaderboardLeaderboardCharactersGet(sort, name, page, size);
        // TODO: test validations
    }
