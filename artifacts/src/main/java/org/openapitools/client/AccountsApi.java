...
public class AccountsApi {
    ...
    /**
     * Build call for getAccountCharactersAccountsAccountCharactersGet
     * @param account The character name. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call getAccountCharactersAccountsAccountCharactersGetCall(String account, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/accounts/{account}/characters"
            .replace("{" + "account" + "}", localVarApiClient.escapeString(account.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAccountCharactersAccountsAccountCharactersGetValidateBeforeCall(String account, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'account' is set
        if (account == null) {
            throw new ApiException("Missing the required parameter 'account' when calling getAccountCharactersAccountsAccountCharactersGet(Async)");
        }

        return getAccountCharactersAccountsAccountCharactersGetCall(account, _callback);
     ...
     */
    public CharactersListSchema getAccountCharactersAccountsAccountCharactersGet(String account) throws ApiException {
        ApiResponse<CharactersListSchema> localVarResp = getAccountCharactersAccountsAccountCharactersGetWithHttpInfo(account);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CharactersListSchema> getAccountCharactersAccountsAccountCharactersGetWithHttpInfo(String account) throws ApiException {
        okhttp3.Call localVarCall = getAccountCharactersAccountsAccountCharactersGetValidateBeforeCall(account, null);
        Type localVarReturnType = new TypeToken<CharactersListSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get Account Characters (asynchronously)
     * Account character lists.
     * @param account The character name. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getAccountCharactersAccountsAccountCharactersGetAsync(String account, final ApiCallback<CharactersListSchema> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAccountCharactersAccountsAccountCharactersGetValidateBeforeCall(account, _callback);
        Type localVarReturnType = new TypeToken<CharactersListSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
