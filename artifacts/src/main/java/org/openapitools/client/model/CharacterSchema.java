...
public class CharacterSchema {
  ...
  public static final String SERIALIZED_NAME_ALCHEMY_XP = "alchemy_xp";
  @SerializedName(SERIALIZED_NAME_ALCHEMY_XP)
  private Integer alchemyXp;

  public static final String SERIALIZED_NAME_ALCHEMY_MAX_XP = "alchemy_max_xp";
  @SerializedName(SERIALIZED_NAME_ALCHEMY_MAX_XP)
  private Integer alchemyMaxXp;

  public static final String SERIALIZED_NAME_HP = "hp";
  @SerializedName(SERIALIZED_NAME_HP)
  private Integer hp;

  public static final String SERIALIZED_NAME_MAX_HP = "max_hp";
  @SerializedName(SERIALIZED_NAME_MAX_HP)
  ...
  public static final String SERIALIZED_NAME_WISDOM = "wisdom";
  @SerializedName(SERIALIZED_NAME_WISDOM)
  private Integer wisdom;

  public static final String SERIALIZED_NAME_PROSPECTING = "prospecting";
  @SerializedName(SERIALIZED_NAME_PROSPECTING)
  private Integer prospecting;
  ...
  public static final String SERIALIZED_NAME_DMG = "dmg";
  @SerializedName(SERIALIZED_NAME_DMG)
  private Integer dmg;
  ...
  public static final String SERIALIZED_NAME_RUNE_SLOT = "rune_slot";
  @SerializedName(SERIALIZED_NAME_RUNE_SLOT)
  private String runeSlot;
  ...
  public static final String SERIALIZED_NAME_UTILITY1_SLOT = "utility1_slot";
  @SerializedName(SERIALIZED_NAME_UTILITY1_SLOT)
  private String utility1Slot;

  public static final String SERIALIZED_NAME_UTILITY1_SLOT_QUANTITY = "utility1_slot_quantity";
  @SerializedName(SERIALIZED_NAME_UTILITY1_SLOT_QUANTITY)
  private Integer utility1SlotQuantity;

  public static final String SERIALIZED_NAME_UTILITY2_SLOT = "utility2_slot";
  @SerializedName(SERIALIZED_NAME_UTILITY2_SLOT)
  private String utility2Slot;

  public static final String SERIALIZED_NAME_UTILITY2_SLOT_QUANTITY = "utility2_slot_quantity";
  @SerializedName(SERIALIZED_NAME_UTILITY2_SLOT_QUANTITY)
  private Integer utility2SlotQuantity;

  public static final String SERIALIZED_NAME_BAG_SLOT = "bag_slot";
  @SerializedName(SERIALIZED_NAME_BAG_SLOT)
  ...
  **/
  ...
  public CharacterSchema account(String account) {
  ...
  **/
  ...
  public CharacterSchema skin(CharacterSkin skin) {
    this.skin = skin;
    return this;
  }
  ...
  **/
  ...
  public CharacterSchema alchemyLevel(Integer alchemyLevel) {
  ...
  **/
  ...
  public CharacterSchema alchemyXp(Integer alchemyXp) {
  ...
  **/
  @javax.annotation.Nonnull
  public Integer getAlchemyXp() {
    return alchemyXp;
  }

  public void setAlchemyXp(Integer alchemyXp) {
    this.alchemyXp = alchemyXp;
  }


  public CharacterSchema alchemyMaxXp(Integer alchemyMaxXp) {
  ...
  **/
  @javax.annotation.Nonnull
  public Integer getAlchemyMaxXp() {
    return alchemyMaxXp;
  }

  public void setAlchemyMaxXp(Integer alchemyMaxXp) {
    this.alchemyMaxXp = alchemyMaxXp;
  }
  ...
  **/
  ...
  public CharacterSchema maxHp(Integer maxHp) {
    this.maxHp = maxHp;
    return this;
  }
  ...
  **/
  ...
  public CharacterSchema wisdom(Integer wisdom) {
    this.wisdom = wisdom;
    return this;
  }
  ...
  **/
  ...
  public CharacterSchema prospecting(Integer prospecting) {
  ...
  **/
  ...
  public CharacterSchema dmg(Integer dmg) {
    this.dmg = dmg;
    return this;
  }
  ...
  **/
  ...
  public CharacterSchema runeSlot(String runeSlot) {
  ...
  **/
  @javax.annotation.Nonnull
  public String getRuneSlot() {
    return runeSlot;
  }

  public void setRuneSlot(String runeSlot) {
    this.runeSlot = runeSlot;
  }
  ...
  **/
  ...
  public CharacterSchema utility1Slot(String utility1Slot) {
  ...
  **/
  ...
  public void setUtility1Slot(String utility1Slot) {
    this.utility1Slot = utility1Slot;
  }


  public CharacterSchema utility1SlotQuantity(Integer utility1SlotQuantity) {
  ...
  **/
  @javax.annotation.Nonnull
  public Integer getUtility1SlotQuantity() {
    return utility1SlotQuantity;
  }

  public void setUtility1SlotQuantity(Integer utility1SlotQuantity) {
    this.utility1SlotQuantity = utility1SlotQuantity;
  }


  public CharacterSchema utility2Slot(String utility2Slot) {
  ...
  **/
  ...
  public void setUtility2Slot(String utility2Slot) {
    this.utility2Slot = utility2Slot;
  }


  public CharacterSchema utility2SlotQuantity(Integer utility2SlotQuantity) {
  ...
  **/
  @javax.annotation.Nonnull
  public Integer getUtility2SlotQuantity() {
    return utility2SlotQuantity;
  }

  public void setUtility2SlotQuantity(Integer utility2SlotQuantity) {
    this.utility2SlotQuantity = utility2SlotQuantity;
  }


  public CharacterSchema bagSlot(String bagSlot) {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, characterSchema.name) &&
        Objects.equals(this.account, characterSchema.account) &&
        ...
        Objects.equals(this.alchemyLevel, characterSchema.alchemyLevel) &&
        Objects.equals(this.alchemyXp, characterSchema.alchemyXp) &&
        Objects.equals(this.alchemyMaxXp, characterSchema.alchemyMaxXp) &&
        Objects.equals(this.hp, characterSchema.hp) &&
        Objects.equals(this.maxHp, characterSchema.maxHp) &&
        Objects.equals(this.haste, characterSchema.haste) &&
        Objects.equals(this.criticalStrike, characterSchema.criticalStrike) &&
        Objects.equals(this.wisdom, characterSchema.wisdom) &&
        Objects.equals(this.prospecting, characterSchema.prospecting) &&
        ...
        Objects.equals(this.dmg, characterSchema.dmg) &&
        ...
        Objects.equals(this.runeSlot, characterSchema.runeSlot) &&
        ...
        Objects.equals(this.utility1Slot, characterSchema.utility1Slot) &&
        Objects.equals(this.utility1SlotQuantity, characterSchema.utility1SlotQuantity) &&
        Objects.equals(this.utility2Slot, characterSchema.utility2Slot) &&
        Objects.equals(this.utility2SlotQuantity, characterSchema.utility2SlotQuantity) &&
        Objects.equals(this.bagSlot, characterSchema.bagSlot) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, account, skin, level, xp, maxXp, gold, speed, miningLevel, miningXp, miningMaxXp, woodcuttingLevel, woodcuttingXp, woodcuttingMaxXp, fishingLevel, fishingXp, fishingMaxXp, weaponcraftingLevel, weaponcraftingXp, weaponcraftingMaxXp, gearcraftingLevel, gearcraftingXp, gearcraftingMaxXp, jewelrycraftingLevel, jewelrycraftingXp, jewelrycraftingMaxXp, cookingLevel, cookingXp, cookingMaxXp, alchemyLevel, alchemyXp, alchemyMaxXp, hp, maxHp, haste, criticalStrike, wisdom, prospecting, attackFire, attackEarth, attackWater, attackAir, dmg, dmgFire, dmgEarth, dmgWater, dmgAir, resFire, resEarth, resWater, resAir, x, y, cooldown, cooldownExpiration, weaponSlot, runeSlot, shieldSlot, helmetSlot, bodyArmorSlot, legArmorSlot, bootsSlot, ring1Slot, ring2Slot, amuletSlot, artifact1Slot, artifact2Slot, artifact3Slot, utility1Slot, utility1SlotQuantity, utility2Slot, utility2SlotQuantity, bagSlot, task, taskType, taskProgress, taskTotal, inventoryMaxItems, inventory);
  }
  ...
  public String toString() {
    ...
    sb.append("    alchemyXp: ").append(toIndentedString(alchemyXp)).append("\n");
    sb.append("    alchemyMaxXp: ").append(toIndentedString(alchemyMaxXp)).append("\n");
    ...
    sb.append("    dmg: ").append(toIndentedString(dmg)).append("\n");
    ...
    sb.append("    runeSlot: ").append(toIndentedString(runeSlot)).append("\n");
    ...
    sb.append("    utility1Slot: ").append(toIndentedString(utility1Slot)).append("\n");
    sb.append("    utility1SlotQuantity: ").append(toIndentedString(utility1SlotQuantity)).append("\n");
    sb.append("    utility2Slot: ").append(toIndentedString(utility2Slot)).append("\n");
    sb.append("    utility2SlotQuantity: ").append(toIndentedString(utility2SlotQuantity)).append("\n");
    sb.append("    bagSlot: ").append(toIndentedString(bagSlot)).append("\n");
  ...
  static {
    ...
    openapiFields.add("alchemy_xp");
    openapiFields.add("alchemy_max_xp");
    openapiFields.add("hp");
    openapiFields.add("max_hp");
    openapiFields.add("haste");
    openapiFields.add("critical_strike");
    openapiFields.add("wisdom");
    ...
    openapiFields.add("utility1_slot");
    openapiFields.add("utility1_slot_quantity");
    openapiFields.add("utility2_slot");
    openapiFields.add("utility2_slot_quantity");
    openapiFields.add("bag_slot");
    ...
    openapiRequiredFields.add("alchemy_xp");
    openapiRequiredFields.add("alchemy_max_xp");
    openapiRequiredFields.add("hp");
    openapiRequiredFields.add("max_hp");
    openapiRequiredFields.add("haste");
    openapiRequiredFields.add("critical_strike");
    openapiRequiredFields.add("wisdom");
    openapiRequiredFields.add("prospecting");
    ...
    openapiRequiredFields.add("rune_slot");
    ...
    openapiRequiredFields.add("utility1_slot");
    openapiRequiredFields.add("utility1_slot_quantity");
    openapiRequiredFields.add("utility2_slot");
    openapiRequiredFields.add("utility2_slot_quantity");
    openapiRequiredFields.add("bag_slot");
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      CharacterSkin.validateJsonElement(jsonObj.get("skin"));
      ...
      if (!jsonObj.get("rune_slot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `rune_slot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("rune_slot").toString()));
      }
      ...
      if (!jsonObj.get("utility1_slot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `utility1_slot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("utility1_slot").toString()));
      }
      if (!jsonObj.get("utility2_slot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `utility2_slot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("utility2_slot").toString()));
      }
      if (!jsonObj.get("bag_slot").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `bag_slot` to be a primitive type in the JSON string but got `%s`", jsonObj.get("bag_slot").toString()));
      }
