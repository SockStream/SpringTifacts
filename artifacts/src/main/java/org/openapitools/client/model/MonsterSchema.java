...
public class MonsterSchema {
  ...
  private List<SimpleEffectSchema> effects = new ArrayList<>();
  ...
  **/
  ...
  public MonsterSchema criticalStrike(Integer criticalStrike) {
  ...
  **/
  ...
  public MonsterSchema effects(List<SimpleEffectSchema> effects) {
    this.effects = effects;
    return this;
  }

  public MonsterSchema addEffectsItem(SimpleEffectSchema effectsItem) {
  ...
  **/
  ...
  public List<SimpleEffectSchema> getEffects() {
    return effects;
  }

  public void setEffects(List<SimpleEffectSchema> effects) {
    this.effects = effects;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.name, monsterSchema.name) &&
        ...
        Objects.equals(this.criticalStrike, monsterSchema.criticalStrike) &&
        Objects.equals(this.effects, monsterSchema.effects) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, code, level, hp, attackFire, attackEarth, attackWater, attackAir, resFire, resEarth, resWater, resAir, criticalStrike, effects, minGold, maxGold, drops);
  }
      ...
      if (jsonObj.get("effects") != null && !jsonObj.get("effects").isJsonNull()) {
        ...
        if (jsonArrayeffects != null) {
          ...
          for (int i = 0; i < jsonArrayeffects.size(); i++) {
            SimpleEffectSchema.validateJsonElement(jsonArrayeffects.get(i));
          };
        }
      }
      // ensure the json data is an array
