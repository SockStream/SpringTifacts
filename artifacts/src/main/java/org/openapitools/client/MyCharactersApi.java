...
import org.openapitools.client.model.NpcMerchantBuySchema;
import org.openapitools.client.model.NpcMerchantTransactionResponseSchema;
...
public class MyCharactersApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 484 </td><td> Character can&#39;t equip more than 100 utilities in the same slot. </td><td>  -  </td></tr>
        <tr><td> 497 </td><td> Character inventory is full. </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * Build call for actionNpcBuyItemMyNameActionNpcBuyPost
     * @param name Name of your character. (required)
     * @param npcMerchantBuySchema  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Item successfully bought from the NPC. </td><td>  -  </td></tr>
        <tr><td> 598 </td><td> NPC not found on this map. </td><td>  -  </td></tr>
        <tr><td> 498 </td><td> Character not found. </td><td>  -  </td></tr>
        <tr><td> 497 </td><td> Character inventory is full. </td><td>  -  </td></tr>
        <tr><td> 499 </td><td> Character in cooldown. </td><td>  -  </td></tr>
        <tr><td> 486 </td><td> An action is already in progress by your character. </td><td>  -  </td></tr>
        <tr><td> 492 </td><td> Insufficient gold on your character. </td><td>  -  </td></tr>
        <tr><td> 441 </td><td> This item cannot be purchased. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Item not found. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call actionNpcBuyItemMyNameActionNpcBuyPostCall(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        Object localVarPostBody = npcMerchantBuySchema;

        // create path and map variables
        String localVarPath = "/my/{name}/action/npc/buy"
            .replace("{" + "name" + "}", localVarApiClient.escapeString(name.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call actionNpcBuyItemMyNameActionNpcBuyPostValidateBeforeCall(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling actionNpcBuyItemMyNameActionNpcBuyPost(Async)");
        }

        // verify the required parameter 'npcMerchantBuySchema' is set
        if (npcMerchantBuySchema == null) {
            throw new ApiException("Missing the required parameter 'npcMerchantBuySchema' when calling actionNpcBuyItemMyNameActionNpcBuyPost(Async)");
        }

        return actionNpcBuyItemMyNameActionNpcBuyPostCall(name, npcMerchantBuySchema, _callback);
     ...
     */
    public NpcMerchantTransactionResponseSchema actionNpcBuyItemMyNameActionNpcBuyPost(String name, NpcMerchantBuySchema npcMerchantBuySchema) throws ApiException {
        ApiResponse<NpcMerchantTransactionResponseSchema> localVarResp = actionNpcBuyItemMyNameActionNpcBuyPostWithHttpInfo(name, npcMerchantBuySchema);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NpcMerchantTransactionResponseSchema> actionNpcBuyItemMyNameActionNpcBuyPostWithHttpInfo(String name, NpcMerchantBuySchema npcMerchantBuySchema) throws ApiException {
        okhttp3.Call localVarCall = actionNpcBuyItemMyNameActionNpcBuyPostValidateBeforeCall(name, npcMerchantBuySchema, null);
        Type localVarReturnType = new TypeToken<NpcMerchantTransactionResponseSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Action Npc Buy Item (asynchronously)
     * Buy an item from an NPC on the character&#39;s map.
     * @param name Name of your character. (required)
     * @param npcMerchantBuySchema  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call actionNpcBuyItemMyNameActionNpcBuyPostAsync(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback<NpcMerchantTransactionResponseSchema> _callback) throws ApiException {

        okhttp3.Call localVarCall = actionNpcBuyItemMyNameActionNpcBuyPostValidateBeforeCall(name, npcMerchantBuySchema, _callback);
        Type localVarReturnType = new TypeToken<NpcMerchantTransactionResponseSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for actionNpcSellItemMyNameActionNpcSellPost
     * @param name Name of your character. (required)
     * @param npcMerchantBuySchema  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Item successfully sold to the NPC. </td><td>  -  </td></tr>
        <tr><td> 598 </td><td> NPC not found on this map. </td><td>  -  </td></tr>
        <tr><td> 498 </td><td> Character not found. </td><td>  -  </td></tr>
        <tr><td> 497 </td><td> Character inventory is full. </td><td>  -  </td></tr>
        <tr><td> 499 </td><td> Character in cooldown. </td><td>  -  </td></tr>
        <tr><td> 486 </td><td> An action is already in progress by your character. </td><td>  -  </td></tr>
        <tr><td> 478 </td><td> Missing item or insufficient quantity. </td><td>  -  </td></tr>
        <tr><td> 442 </td><td> This item cannot be sold. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Item not found. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call actionNpcSellItemMyNameActionNpcSellPostCall(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
        ...
        // create path and map variables
        String localVarPath = "/my/{name}/action/npc/sell"
            .replace("{" + "name" + "}", localVarApiClient.escapeString(name.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call actionNpcSellItemMyNameActionNpcSellPostValidateBeforeCall(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
            throw new ApiException("Missing the required parameter 'name' when calling actionNpcSellItemMyNameActionNpcSellPost(Async)");
        }

        // verify the required parameter 'npcMerchantBuySchema' is set
        if (npcMerchantBuySchema == null) {
            throw new ApiException("Missing the required parameter 'npcMerchantBuySchema' when calling actionNpcSellItemMyNameActionNpcSellPost(Async)");
        }

        return actionNpcSellItemMyNameActionNpcSellPostCall(name, npcMerchantBuySchema, _callback);
     ...
     */
    public NpcMerchantTransactionResponseSchema actionNpcSellItemMyNameActionNpcSellPost(String name, NpcMerchantBuySchema npcMerchantBuySchema) throws ApiException {
        ApiResponse<NpcMerchantTransactionResponseSchema> localVarResp = actionNpcSellItemMyNameActionNpcSellPostWithHttpInfo(name, npcMerchantBuySchema);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NpcMerchantTransactionResponseSchema> actionNpcSellItemMyNameActionNpcSellPostWithHttpInfo(String name, NpcMerchantBuySchema npcMerchantBuySchema) throws ApiException {
        okhttp3.Call localVarCall = actionNpcSellItemMyNameActionNpcSellPostValidateBeforeCall(name, npcMerchantBuySchema, null);
        Type localVarReturnType = new TypeToken<NpcMerchantTransactionResponseSchema>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Action Npc Sell Item (asynchronously)
     * Sell an item to an NPC on the character&#39;s map.
     * @param name Name of your character. (required)
     * @param npcMerchantBuySchema  (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call actionNpcSellItemMyNameActionNpcSellPostAsync(String name, NpcMerchantBuySchema npcMerchantBuySchema, final ApiCallback<NpcMerchantTransactionResponseSchema> _callback) throws ApiException {

        okhttp3.Call localVarCall = actionNpcSellItemMyNameActionNpcSellPostValidateBeforeCall(name, npcMerchantBuySchema, _callback);
        Type localVarReturnType = new TypeToken<NpcMerchantTransactionResponseSchema>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The item has been successfully unequipped and added in their inventory. </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> Item not found. </td><td>  -  </td></tr>
        <tr><td> 498 </td><td> Character not found. </td><td>  -  </td></tr>
        <tr><td> 486 </td><td> An action is already in progress by your character. </td><td>  -  </td></tr>
